...
public final class CadastroProdutoDialog extends javax.swing.JDialog {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(edtDescricaoProduto)
                    ...
                    .addComponent(jListaDeDepartamentos, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double preco = Double.parseDouble(edtPreco.getText());
        int estoqueAtual = Integer.parseInt(edtEstoqueAtual.getText());
        ...
        if (UtilsValidacao.isNullOuVazio(String.valueOf(preco))) {
        ...
        if (UtilsValidacao.isNullOuVazio(String.valueOf(estoqueAtual))) {
            new AvisosDialog(null, true, "O preenchimento do campo preço é obrigatório.", true);
        ...
        Produto produto = new Produto(nomeProduto, departamento, preco, cod, estoqueAtual);
    ...
    private void edtPrecoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_edtPrecoKeyTyped
        ...
        if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)) {
            evt.consume();
            new AvisosDialog(null, true, "O campo preço só aceita valores númericos.", true);
        }
